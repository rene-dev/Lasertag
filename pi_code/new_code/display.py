...
class Display:
    ...
    def redraw(self):
        ...
        self.pygame.draw.rect(self.screen, (127, 127, 127), (5, 5, 3, 10), 0)
        self.pygame.draw.rect(self.screen, (127, 127, 127), (10, 8, 3, 7), 0)
        self.pygame.draw.rect(self.screen, (127, 127, 127), (15, 12, 3, 3), 0)
        self.pygame.draw.rect(self.screen, (127, 127, 127), (0, 70, 240, 3), 0)
        self.pygame.draw.rect(self.screen, (127, 127, 127), (0, 120, 240, 3), 0)
